...
def pong(request):
    ...
    # context = {'name' : name}
    return render(request, 'practices/pong.html', context={'ball' : request.GET.get('ball')})

def nct(request):
    return render(request, 'practices/nct.html')
...
def nctmatch(request):
    ...
    return render(request, 'practices/nctmatch.html', context)
...
def lorem_result(request):
    ...
    return render(request, 'practices/lorem_result.html', context)
